...
# fixes the width and height of the gui, hence it can't be expanded/stretched
...
# here i will count the rows for placing buttons in the grid
i = 0
...
# use askyesno function to stop/continue the program exection
def iExit():
